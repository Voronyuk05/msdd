    ...
    return (
        <div className={styles.logo}>
            <div className={styles.logo_item}>
                ...
                <Headings color="secondary" heading="h5" weight="700">Міжнародний Спеціалізований Департамент Детективів</Headings>
            </div>
            <div className={styles.line}></div>
            <div className={styles.logo_item}>
                <Image src={european_flag} alt='флаг Європи' priority width={50} height={37}/>
                <Headings color='primary' heading='h5' weight='700'>International Specialized Department Of Detectives</Headings>
            </div>
        </div>
    )
}