        ...
        <Section section_class="solving_crimes">
            ...
            <div className="content">
                <div className="article">
                    <Headings heading='h3' color='black' weight='700' className='article_title'>Послуги охорони — Міжнародний — Спеціалізований Департамент Детективів</Headings>
                ...
                <div className="article">
                    ...
                    <Paragraph color='black' weight='500' className='article_text'>Питання охорони та безпеки дуже важливе, тому варто довіритися справжнім професіоналам у даній справі. Міжнародний — Спеціалізований Департамент Детективів надає найкращі послуги з охорони в Києві, Україні та ставить понад усе комфорт та безпеку клієнта, конфіденційність та роботу в рамках правових та законодавчих норм.</Paragraph>
                </div>
            </div>    
        </Section>
    )
