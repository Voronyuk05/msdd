    ...
    return (
        <Section section_class="solving_crimes">
            ...
            <div className="content">
                ...
                <div className="article">
                    <Headings heading='h3' color='black' weight='700' className='article_title'>Міжнародний — Спеціалізований Департамент Детективів: як отримати повний внутрішній контроль в Вашій організації</Headings>
