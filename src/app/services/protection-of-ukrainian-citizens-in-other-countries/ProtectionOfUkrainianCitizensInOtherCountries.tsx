        ...
        <Section section_class="solving_crimes">
            ...
            <div className="content">
                <div className="article">
                    <Headings heading='h3' color='black' weight='700' className='article_title'>Захист громадян України в інших країнах: Міжнародний — Спеціалізований Департамент Детективів</Headings>
