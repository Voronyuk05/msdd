        ...
        <Section section_class="solving_crimes">
            ...
            <div className="content">
                <div className="article">
                    ...
                    <Paragraph color='black' weight='500' className='article_text'>Однак, навіть наявність банківської гарантії не виключає ризиків шахрайства або умисного ухилення від боргів. Саме в таких ситуаціях Міжнародний - Спеціалізований Департамент Детективів розпочинає розслідування та застосовує комплекс заходів для повернення коштів.</Paragraph>
                </div>
                <div className="article">
                    <Headings heading='h3' color='black' weight='700' className='article_title'>Як Міжнародний - Спеціалізований Департамент Детективів допомагає у поверненні боргів під гарантіями банку?</Headings>
