        ...
        <Section section_class={styles.our_mission_section}>
            ...
            <div className="content">
                <div className="article">
                    <Headings heading='h3' color='black' weight='700' className='article_title'>Міжнародний — Спеціалізований Департамент Детективів — професійна команда на боці пошуку та відстоювання справедливості</Headings>
                    <Paragraph color='black' weight='500' className='article_text'>Міжнародний — Спеціалізований Департамент Детективів було створено командою професіональних співробітників спецслужб, правоохоронних органів та детективних агентств, які закінчили свою трудову діяльність на державні структури і розпочали власну справу безпосередньо на користь наших громадян.</Paragraph>
                    ...
                    <Paragraph color='black' weight='500' className='article_text'>Основна мета Міжнародного — Спеціалізованого Департаменту Детективів – це захист прав наших громадян і допомога в відновленні справедливості. Кожна справа розслідується професійно і прискіпливо до усіх деталей.</Paragraph>
